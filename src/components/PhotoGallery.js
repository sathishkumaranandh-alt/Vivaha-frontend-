    ...
    <div>
            ...
            <div key={i} style={thumbWrapperStyle(isPrimarySlot, !!photo)}>
              {photo ? (
                <>
                  ...
                  {/* Set as main (only for non-primary) */}
                  ...
                  {/* Delete (only non-primary slots — main delete is on the big photo) */}
                  {!isPrimarySlot && !readOnly && (
                    <button
      ...
      <p style={hintStyle}>
        ...
        {!readOnly && photos.length > 0 && (
          <> • Tap <strong>SET MAIN</strong> on any photo to make it your primary</>
        )}
      </p>
    </div>
  );
