...
function Profile() {
  ...
  const handleSave = async (e) => {
    ...
    try {
      ...
      // Clean up the data: convert empty strings to null for Date/Number columns
      const cleanedProfile = { ...profile };
      const nullableDateFields = ["dob"];
      const nullableNumberFields = ["age", "pref_age_min", "pref_age_max", "brothers", "sisters", "income"];
