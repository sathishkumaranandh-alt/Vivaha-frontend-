      ...
      <div style={viewCardStyle}>
        ...
        <div style={viewActionsStyle}>
          {isOwnProfile ? (
            ...
            <>
              <Link to={`/messages?to=${id}`} style={primaryActionBtn}>💬 Send Message</Link>
              <button onClick={() => setShowReportModal(true)} style={reportActionBtn}>🚨 Report</button>
              <Link to="/matches" style={secondaryActionBtn}>← Matches</Link>
            </>
          )}
        </div>
      </div>
