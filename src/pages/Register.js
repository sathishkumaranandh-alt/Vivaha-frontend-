...
const COMMUNITIES = [
  ...
  { value: "kallar", label: "Kallar", emoji: "⚡" },
  { value: "thevar", label: "Thevar", emoji: "🌟" },
...
function Register() {
  ...
  // Prefill community from URL (?community=vanniyar)
  useEffect(() => {
 ...
 const prevStep = () => {
  ...
  const handleStep1 = async () => {
    ...
    try {
      ...
      if (error) {
        // If already registered, try to sign in and continue
            ...
            <div style={communityGridStyle}>
              {COMMUNITIES.map((c) => (
                <button
                  key={c.value}
                  type="button"
                  onClick={() => update("community", c.value)}
                  style={{
                    ...communityCardStyle,
                    border:
                      form.community === c.value
                        ...
                        : "2px solid #e5e7eb",
                    background:
                      form.community === c.value ? "#eff6ff" : "white",
                    color:
                      form.community === c.value ? "#1e3a8a" : "#555",
                  }}
                >
        ...
        {step === 3 && (
          <div style={formWrapStyle}>
            ...
            <textarea
              ...
              style={textareaStyle}
            />
            <p style={{ textAlign: "right", fontSize: "11px", color: "#888", margin: "-6px 0 0 0" }}>
              {form.bio.length}/500
            </p>
          ...
          <div style={formWrapStyle}>
            ...
            <div style={btnRowStyle}>
              ...
              <button
                ...
                style={{ ...primaryBtnStyle, flex: 1, background: "linear-gradient(135deg, #16a34a, #22c55e)" }}
              >
