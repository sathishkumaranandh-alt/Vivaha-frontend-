  ...
  const handleSave = async (e) => {
    ...
    try {
      ...
      const profileData = {
        ...
        brothers: parseInt(profile.brothers) || 0,
        sisters: parseInt(profile.sisters) || 0,
        pref_age_min: parseInt(profile.pref_age_min) || null,
        pref_age_max: parseInt(profile.pref_age_max) || null,
    ...
    return (
      <div style={{ maxWidth: "700px", margin: "0 auto", padding: "20px" }}>
        ...
        <form onSubmit={handleSave} style={{ background: "white", borderRadius: "14px", padding: "24px", border: "1px solid #f0e0e0" }}>
          ...
          <h3 style={{ color: "#8B0A2E", fontSize: "14px", marginBottom: "12px", borderBottom: "1px solid #f0e0e0", paddingBottom: "6px" }}>Basic Details</h3>
          {[
            { label: "Name", key: "name", type: "text" },
            { label: "Profile Created For", key: "profile_for", type: "text" },
            ...
            <div key={f.key} style={{ marginBottom: "14px" }}>
              ...
              <input type={f.type} value={profile[f.key] || ""} onChange={(e) => setProfile({ ...profile, [f.key]: e.target.value })} style={inputStyle} />
            </div>
          ))}
          ...
          <div style={{ marginBottom: "14px" }}>
            ...
            <select value={profile.marital_status} onChange={(e) => setProfile({ ...profile, marital_status: e.target.value })} style={inputStyle}>
          ...
          <h3 style={{ color: "#8B0A2E", fontSize: "14px", margin: "24px 0 12px", borderBottom: "1px solid #f0e0e0", paddingBottom: "6px" }}>Community & Horoscope</h3>
          {[
            { label: "Religion", key: "religion", type: "text" },
            { label: "Community / Caste", key: "caste", type: "text" },
            { label: "Sub-Caste", key: "sub_caste", type: "text" },
            { label: "Gothram", key: "gothram", type: "text" },
            { label: "Rasi", key: "rasi", type: "text" },
            { label: "Nakshatra", key: "nakshatra", type: "text" },
          ].map((f) => (
            <div key={f.key} style={{ marginBottom: "14px" }}>
              <label style={labelStyle}>{f.label}</label>
              <input type={f.type} value={profile[f.key] || ""} onChange={(e) => setProfile({ ...profile, [f.key]: e.target.value })} style={inputStyle} />
          ...
          <div style={{ marginBottom: "14px" }}>
            <label style={labelStyle}>Horoscope Available?</label>
            <select value={profile.horoscope} onChange={(e) => setProfile({ ...profile, horoscope: e.target.value })} style={inputStyle}>
              <option value="Available">Available</option>
              <option value="Not Available">Not Available</option>
            </select>
          </div>

          <h3 style={{ color: "#8B0A2E", fontSize: "14px", margin: "24px 0 12px", borderBottom: "1px solid #f0e0e0", paddingBottom: "6px" }}>Education & Career</h3>
          {[
          ...
          <h3 style={{ color: "#8B0A2E", fontSize: "14px", margin: "24px 0 12px", borderBottom: "1px solid #f0e0e0", paddingBottom: "6px" }}>Family & Lifestyle</h3>
          {[
            { label: "Father's Occupation", key: "father_occ", type: "text" },
            { label: "Mother's Occupation", key: "mother_occ", type: "text" },
            { label: "Brothers", key: "brothers", type: "number" },
            { label: "Sisters", key: "sisters", type: "number" },
          ].map((f) => (
            <div key={f.key} style={{ marginBottom: "14px" }}>
              <label style={labelStyle}>{f.label}</label>
              <input type={f.type} value={profile[f.key] || ""} onChange={(e) => setProfile({ ...profile, [f.key]: e.target.value })} style={inputStyle} />
          ...
          <div style={{ marginBottom: "14px" }}>
            ...
            <select value={profile.family_type} onChange={(e) => setProfile({ ...profile, family_type: e.target.value })} style={inputStyle}>
          ...
          <div style={{ marginBottom: "14px" }}>
            ...
            <select value={profile.food_pref} onChange={(e) => setProfile({ ...profile, food_pref: e.target.value })} style={inputStyle}>
          ...
          <div style={{ marginBottom: "14px" }}>
            ...
            <textarea value={profile.bio} onChange={(e) => setProfile({ ...profile, bio: e.target.value })} rows={4} maxLength={500} style={{ ...inputStyle, resize: "vertical" }} />
          </div>

          <h3 style={{ color: "#8B0A2E", fontSize: "14px", margin: "24px 0 12px", borderBottom: "1px solid #f0e0e0", paddingBottom: "6px" }}>Partner Preferences</h3>
          {[
            { label: "Preferred Age From", key: "pref_age_min", type: "number" },
            { label: "Preferred Age To", key: "pref_age_max", type: "number" },
            { label: "Preferred Height", key: "pref_height", type: "text" },
            { label: "Preferred Community", key: "pref_community", type: "text" },
            { label: "Preferred Education", key: "pref_education", type: "text" },
            { label: "Preferred Occupation", key: "pref_occupation", type: "text" },
            { label: "Preferred Location", key: "pref_location", type: "text" },
          ].map((f) => (
            <div key={f.key} style={{ marginBottom: "14px" }}>
              <label style={labelStyle}>{f.label}</label>
              <input type={f.type} value={profile[f.key] || ""} onChange={(e) => setProfile({ ...profile, [f.key]: e.target.value })} style={inputStyle} />
          ...
          {profile.custom_fields && Object.keys(profile.custom_fields).length > 0 && (
            <>
              <h3 style={{ color: "#8B0A2E", fontSize: "14px", margin: "24px 0 12px", borderBottom: "1px solid #f0e0e0", paddingBottom: "6px" }}>Additional Details</h3>
              {Object.entries(profile.custom_fields).map(([key, value]) => (
                <div key={key} style={{ marginBottom: "14px" }}>
                  <label style={labelStyle}>{key.replace(/_/g, " ")}</label>
                  <input type="text" value={value || ""} onChange={(e) => setProfile({ ...profile, custom_fields: { ...profile.custom_fields, [key]: e.target.value } })} style={inputStyle} />
                </div>
              ))}
            </>
          )}
        ...
        <div style={S.mainCard}>
          ...
          <div style={S.tabs}>
            {["about", "community", "family", "preferences"].map((t) => (
              ...
              >
                {t === "about" ? "About" :
                 t === "community" ? "Community & Horoscope" :
          ...
          {activeTab === "community" && (
            <div style={{ display: "flex", flexDirection: "column", gap: "10px" }}>
              <div style={S.qiRow}><span style={S.qiLabel}>Religion</span><span style={S.qiValue}>{profile.religion || "—"}</span></div>
              <div style={S.qiRow}><span style={S.qiLabel}>Caste</span><span style={S.qiValue}>{profile.caste || "—"}</span></div>
              <div style={S.qiRow}><span style={S.qiLabel}>Sub-Caste</span><span style={S.qiValue}>{profile.sub_caste || "—"}</span></div>
              <div style={S.qiRow}><span style={S.qiLabel}>Gothram</span><span style={S.qiValue}>{profile.gothram || "—"}</span></div>
              <div style={S.qiRow}><span style={S.qiLabel}>Horoscope</span><span style={S.qiValue}>{profile.horoscope || "—"}</span></div>
              <div style={S.qiRow}><span style={S.qiLabel}>Rasi</span><span style={S.qiValue}>{profile.rasi || "—"}</span></div>
              <div style={S.qiRow}><span style={S.qiLabel}>Nakshatra</span><span style={S.qiValue}>{profile.nakshatra || "—"}</span></div>
            </div>
          )}

          {activeTab === "family" && (
            <div style={{ display: "flex", flexDirection: "column", gap: "10px" }}>
              <div style={S.qiRow}><span style={S.qiLabel}>Father's Occ.</span><span style={S.qiValue}>{profile.father_occ || "—"}</span></div>
              <div style={S.qiRow}><span style={S.qiLabel}>Mother's Occ.</span><span style={S.qiValue}>{profile.mother_occ || "—"}</span></div>
              ...
              <div style={S.qiRow}><span style={S.qiLabel}>Family Type</span><span style={S.qiValue}>{profile.family_type || "—"}</span></div>
              <div style={S.qiRow}><span style={S.qiLabel}>Food Pref.</span><span style={S.qiValue}>{profile.food_pref || "—"}</span></div>
            </div>
          )}

          {activeTab === "preferences" && (
            <div style={{ display: "flex", flexDirection: "column", gap: "10px" }}>
              <div style={S.qiRow}><span style={S.qiLabel}>Age Range</span><span style={S.qiValue}>{profile.pref_age_min || "—"} - {profile.pref_age_max || "—"} yrs</span></div>
              <div style={S.qiRow}><span style={S.qiLabel}>Height</span><span style={S.qiValue}>{profile.pref_height || "—"}</span></div>
              <div style={S.qiRow}><span style={S.qiLabel}>Community</span><span style={S.qiValue}>{profile.pref_community || "—"}</span></div>
              <div style={S.qiRow}><span style={S.qiLabel}>Education</span><span style={S.qiValue}>{profile.pref_education || "—"}</span></div>
              <div style={S.qiRow}><span style={S.qiLabel}>Occupation</span><span style={S.qiValue}>{profile.pref_occupation || "—"}</span></div>
              <div style={S.qiRow}><span style={S.qiLabel}>Location</span><span style={S.qiValue}>{profile.pref_location || "—"}</span></div>
            </div>
          )}
        </div>
